...
namespace Chess.Pieces
{
    class Knight : IChessPieces
    {
        ...
        {
            string move1 = $"{i + 2}.{j + 1}";
            string move2 = $"{i - 2}.{j + 1}";
            string move3 = $"{i + 1}.{j + 2}";
            string move4 = $"{i - 1}.{j + 2}";
            string move5 = $"{i + 2}.{j - 1}";
            string move6 = $"{i - 2}.{j - 1}";
            string move7 = $"{i + 1}.{j - 2}";
            string move8 = $"{i - 1}.{j - 2}";
        ...
        public void PieceSetter()
        {
            ...
            {
                Piece = Image.FromFile(@"../../Sprites/W_Knight.png");
                Name = "W_Knight";
            }
            else if (Color.Equals("black"))
            {
                Piece = Image.FromFile(@"../../Sprites/B_Knight.png");
                Name = "B_Knight";
